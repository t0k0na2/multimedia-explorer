...
## 外部ライブラリのライセンス (Third-Party Licenses)

このプロジェクトは以下の機能を利用するために、サードパーティ製のライブラリ（オープンソースソフトウェアを含む）を使用しています。
...
- **C++/WinRT (Microsoft.Windows.CppWinRT)**
- **C#/WinRT (Microsoft.Windows.CsWinRT)**
